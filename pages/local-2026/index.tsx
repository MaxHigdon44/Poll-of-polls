    ...
    <PageShell>
      {!isEmbed && (
        <TopNav
          ...
          subtitle={
            selectedCouncilName ? (
              <span style={{ fontSize: '1.1rem', color: 'var(--poll-nav-ink)' }}>{selectedCouncilName}</span>
            ) : (
        ...
        <div className="poll-card poll-map-sidebar" style={{ maxHeight: '100%', overflow: 'auto' }}>
          {selectedLad ? (
            <>
              ...
              {councilComposition ? (
                <>
                  <div style={{ color: 'var(--poll-nav-muted)', marginBottom: '0.5rem' }}>
                ...
                <div style={{ color: 'var(--poll-nav-muted)', fontSize: '0.9rem' }}>
            ...
            <>
              ...
              <div style={{ marginTop: '0.75rem', color: 'var(--poll-nav-muted)' }}>
