...
const SCOTTISH_CONTROL_PARTIES = new Set([
  'SNP',
  'Conservative',
  'Labour',
  'Liberal Democrat',
...
function getScottishControlTextColor(party: string | null | undefined) {
  if (!party || !SCOTTISH_CONTROL_PARTIES.has(party)) return '#f8fafc'
  return SCOTTISH_PARTY_COLORS[party] || '#f8fafc'
}
              ...
              <div style={{ display: 'grid', gap: '0.35rem' }}>
                ...
                {entries.map(entry => (
                  ...
                  >
                    ...
                    <div style={{ color: getScottishControlTextColor(entry.previousWinner2021) }}>
                      {entry.previousWinner2021 || 'Unknown'}
                    </div>
                    <div style={{ color: getScottishControlTextColor(entry.projectedWinner) }}>
