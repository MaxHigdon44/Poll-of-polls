...
export default function ScottishAggregatePage() {
  ...
  const constituencyAggregate = useMemo(() => computeAggregate(constituencyPolls), [constituencyPolls])
  const regionalAggregate = useMemo(() => computeAggregate(regionalPolls), [regionalPolls])
